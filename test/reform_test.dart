...
void main() {
  test("Basic", () {
    SanitizableRefield<String, String> field(String value) => value
  ...
  test("Nullability", () {
    SanitizableRefield field(String? value) => value
  ...
  test("Several sanitizers", () {
    SanitizableRefield<String?, int> field(String? value) => value
        .validate((value) => value == null ? "Can't be null" : null)
        .as<String>()
